...
export default function WorkspacePage() {
  ...
  return <div className="workspace-page"><header className="workspace-header"><div><span className="eyebrow">Secondary capability · Data Lab</span><h1>External trajectory analysis</h1><p>Validate an external CSV, inspect one machine, and request an on-demand FD001 model estimate.</p></div>{state.file && <button className="button ghost" type="button" onClick={reset}><RotateCcw /> New analysis</button>}</header>
