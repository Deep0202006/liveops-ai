...
export default defineConfig({
  ...
  webServer: [
    { command: "set LIVEOPS_MODE=real&& .venv\\Scripts\\python.exe -m uvicorn api.index:app --host 127.0.0.1 --port 8000", cwd: "..", url: "http://127.0.0.1:8000/api/v1/health/live", reuseExistingServer: true, timeout: 120_000 },
